...
export class EngineQueue {
  ...
  readonly #inflight = new Map<string, { promise: Promise<unknown>; controller: AbortController; refs: number }>();

  constructor(options: { concurrency: number; maxWaiting: number }) {
